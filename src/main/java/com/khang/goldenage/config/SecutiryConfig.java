  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
    http
      ...
      .authorizeHttpRequests(auth -> auth
        ...
        .requestMatchers(HttpMethod.GET, "/api/scrape/search").permitAll()
        .requestMatchers(HttpMethod.GET, "/api/scrape/suggestions").permitAll()
        .requestMatchers(HttpMethod.GET, "/api/bookmarks/{userId}").authenticated()
        .requestMatchers(HttpMethod.GET, "/api/bookmarks/isBookmarked/{userId}/{articleId}").authenticated()
        .requestMatchers(HttpMethod.POST, "/api/bookmarks").authenticated()
        .requestMatchers(HttpMethod.DELETE, "/api/bookmarks/{userId}/{articleId}").authenticated()

...
import com.khang.goldenage.repository.NotificationsRepository;
...
public class CronNotifyUserMailService {
  ...
  public void sendDailyGoldPriceNotifications() {
    ...
    String notificationContent = "Giá vàng cập nhật hôm nay: " + goldPrices.get(0).getGoldName() + " - Mua: " + goldPrices.get(0).getPurchasePrice() + ", Bán: " + goldPrices.get(0).getSellPrice() + "..."; // Nội dung tóm tắt cho thông báo in-app
